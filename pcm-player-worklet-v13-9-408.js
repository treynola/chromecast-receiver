...
/**
 * PCM Player AudioWorkletProcessor - TV-Side Resampling [v13.9.408]
 ...
 * [v13.9.408] Restore linear interpolation in the resampling render loop to fix aliasing distortion.
 */
class PCMPlayerProcessor extends AudioWorkletProcessor {
  constructor(options) {
    ...
    this._FLUSH_THRESHOLD = 86400; // [v13.9.408] 900ms — safety margin to prevent flushes
    ...
    for (let i = 0; i < channel0.length; i++) {
      if (available - samplesConsumed >= 4) {
        if (is1x) {
          ...
          // [v13.9.408] Restored Linear Interpolation for high-fidelity sound quality during resampling adjustments
          const frameIndex = readPtrFrames | 0;
          ...
          channel0[i] = valL * INV_32768 * fade;
          channel1[i] = valR * INV_32768 * fade;
