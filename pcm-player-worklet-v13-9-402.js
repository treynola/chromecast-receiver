...
/**
 * PCM Player AudioWorkletProcessor - TV-Side Resampling [v13.9.402]
 * High-Performance direct-copy ring buffer with dynamic local playbackRate adjustment.
 * Pitch and speed are perfectly preserved even under aggressive TV browser throttling.
 */
  ...
  process(inputs, outputs) {
    ...
    if (this._sampleCount >= 48000) {
      ...
      if (measuredHz > 10000 && measuredHz < 100000) {
        ...
        this._baseRate = this._baseRate * 0.9 + measuredRatio * 0.1;
      }
