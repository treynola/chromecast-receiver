...
/**
 * PCM Player AudioWorkletProcessor - TV-Side Resampling [v13.9.444]
 ...
 * [v13.9.444] Removed dynamic calibration (relying on 1.0 base rate ratio) and 
...
class PCMPlayerProcessor extends AudioWorkletProcessor {
  ...
  process(inputs, outputs) {
    ...
    // [v13.9.444] Smooth P-controller for micro-adjusting playbackRate to correct clock drift
    ...
    // [v13.9.444] Reduced from 48000 (1s) to 144000 (3s) to cut TV CPU overhead by 67%
