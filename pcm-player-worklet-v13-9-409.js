...
/**
 * PCM Player AudioWorkletProcessor - TV-Side Resampling [v13.9.409]
 ...
 * [v13.9.409] Restored and highly-optimized linear interpolation in the resampling render loop to fix aliasing distortion with minimum CPU overhead.
 */
class PCMPlayerProcessor extends AudioWorkletProcessor {
  constructor(options) {
    ...
    this._FLUSH_THRESHOLD = 86400; // [v13.9.409] 900ms — safety margin to prevent flushes
    ...
    for (let i = 0; i < channel0.length; i++) {
      if (available - samplesConsumed >= 4) {
        if (is1x) {
          ...
          // [v13.9.409] Restored and highly-optimized Linear Interpolation for high-fidelity sound quality with minimum CPU overhead
          const frameIndex = readPtrFrames | 0;
