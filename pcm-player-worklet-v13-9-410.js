...
/**
 * PCM Player AudioWorkletProcessor - TV-Side Resampling [v13.9.410]
 ...
 * [v13.9.410] Restored and highly-optimized linear interpolation in the resampling render loop to fix aliasing distortion with minimum CPU overhead.
 */
    ...
    for (let i = 0; i < channel0.length; i++) {
      if (available - samplesConsumed >= 4) {
        if (is1x) {
          ...
          // [v13.9.410] Restored and highly-optimized Linear Interpolation for high-fidelity sound quality with minimum CPU overhead
          const frameIndex = readPtrFrames | 0;
