 ...
 * [v13.9.499] CONCRETE SYNC - High-Stability PCM Playout
 */
...
class PCMPlayerProcessor extends AudioWorkletProcessor {
  constructor(options) {
    ...
    // [v13.9.499] CONCRETE SYNC: Jitter-Resilient Targets
    ...
    this._startTime = 0; // [v13.9.499] Local worklet timer for accurate Hz reporting
  ...
  process(inputs, outputs) {
    try {
      ...
      const kp = 0.000005; // [v13.9.499] 25x stronger gain than v494
      ...
      if (this._callbackCount % 120 === 0) {
        ...
        this.port.postMessage({
          ...
          rate: playbackRate,
          measuredHz: Math.round(this._framesProcessed / elapsed), // [v13.9.499] Real clock tracking
